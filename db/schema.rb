...
ActiveRecord::Schema.define(version: 20141111121742) do
  ...
  create_table "places", force: true do |t|
    ...
    t.string   "address_state",              default: "MA"
  ...
  add_index "reviews", ["rating", "user_id", "place_id", "created_at"], name: "index_reviews_on_rating_and_user_id_and_place_id_and_created_at", using: :btree
